...
const HELP = `Usage
 ...
 Options:
  ...
  --use-path-tag-subfolders  [Optional] Organize path handlers into subfolders based on the first OpenAPI tag.
`;
const [, , ...args] = process.argv;
const flags = parser(args, {
    boolean: ['untyped', 'help', 'overrideTypesFile', 'usePathTagSubfolders'],
...
await generate({
    ...
    spec: bundleResults.bundle.parsed,
    ...
    usePathTagSubfolders: !!flags.usePathTagSubfolders,
});
