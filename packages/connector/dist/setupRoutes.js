...
export const validateSecurityObject = (security) => {
...
export const fixEmptyResponses = (responses) => {
    if (!responses) {
        return undefined;
    }
...
export const setupRoutes = (fastify, routesInfo, settings) => {
    ...
    for (const [path, pathObject] of Object.entries(routesInfo.paths)) {
        ...
        const { parameters, 'x-security': xSecurity, ...methods } = pathObject;
        let routeSecurity = undefined;
